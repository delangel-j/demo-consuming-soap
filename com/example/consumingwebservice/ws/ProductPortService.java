 ...
 * 
 */
@WebServiceClient(name = "productPortService", targetNamespace = "http://www.example.com/demosoap/gen", wsdlLocation = "http://localhost:8080/ws/products.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTPORTSERVICE_QNAME = new QName("http://www.example.com/demosoap/gen", "productPortService");
    ...
    public ProductPort getProductPortSoap11() {
        return super.getPort(new QName("http://www.example.com/demosoap/gen", "productPortSoap11"), ProductPort.class);
    }
    ...
    public ProductPort getProductPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.com/demosoap/gen", "productPortSoap11"), ProductPort.class, features);
    }
